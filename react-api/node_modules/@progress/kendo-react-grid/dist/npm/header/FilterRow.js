    ...
    FilterRow.prototype.render = function () {
        ...
        var filterCells = this.props.columns.filter(function (c) { return c.children.length === 0; })
            ...
            var style = column.left !== undefined
                ...
                : {};
            return (React.createElement("th", __assign({ key: key, style: style, className: _this.headerCellClassName(column.field, column.locked) || undefined }, ariaAttrs), filterCellProps && (column.filterCell ?
        ...
        return React.createElement("tr", { className: "k-filter-row", role: "row" }, filterCells);
    };
    return FilterRow;
}(React.Component));
