...
const serializeAws_json1_1AnalyzeDocumentRequest = (input, context) => {
    return Object.assign(Object.assign(Object.assign({}, (input.Document !== undefined && {
...
const serializeAws_json1_1DetectDocumentTextRequest = (input, context) => {
    return Object.assign({}, (input.Document !== undefined && {
        Document: serializeAws_json1_1Document(input.Document, context)
    }));
};
...
const deserializeAws_json1_1AnalyzeDocumentResponse = (output, context) => {
    return {
        ...
        AnalyzeDocumentModelVersion: output.AnalyzeDocumentModelVersion !== undefined &&
...
const deserializeAws_json1_1Block = (output, context) => {
    return {
        __type: "Block",
        BlockType: output.BlockType !== undefined && output.BlockType !== null
            ? output.BlockType
            : undefined,
        ColumnIndex: output.ColumnIndex !== undefined && output.ColumnIndex !== null
            ? output.ColumnIndex
            : undefined,
        ColumnSpan: output.ColumnSpan !== undefined && output.ColumnSpan !== null
            ? output.ColumnSpan
            : undefined,
        ...
        Page: output.Page !== undefined && output.Page !== null
            ? output.Page
            : undefined,
        Relationships: output.Relationships !== undefined && output.Relationships !== null
            ...
            : undefined,
        RowIndex: output.RowIndex !== undefined && output.RowIndex !== null
            ? output.RowIndex
            : undefined,
        RowSpan: output.RowSpan !== undefined && output.RowSpan !== null
            ? output.RowSpan
            : undefined,
        SelectionStatus: output.SelectionStatus !== undefined && output.SelectionStatus !== null
...
const deserializeAws_json1_1DetectDocumentTextResponse = (output, context) => {
    return {
        ...
        Blocks: output.Blocks !== undefined && output.Blocks !== null
            ? deserializeAws_json1_1BlockList(output.Blocks, context)
            : undefined,
        DetectDocumentTextModelVersion: output.DetectDocumentTextModelVersion !== undefined &&
