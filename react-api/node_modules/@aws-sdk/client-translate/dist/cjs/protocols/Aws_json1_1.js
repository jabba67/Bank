...
const serializeAws_json1_1GetTerminologyRequest = (input, context) => {
    return Object.assign(Object.assign({}, (input.Name !== undefined && { Name: input.Name })), (input.TerminologyDataFormat !== undefined && {
...
const serializeAws_json1_1ImportTerminologyRequest = (input, context) => {
    ...
    })), (input.Name !== undefined && { Name: input.Name })), (input.TerminologyData !== undefined && {
...
const serializeAws_json1_1StartTextTranslationJobRequest = (input, context) => {
    var _a;
    return Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({ ClientToken: (_a = input.ClientToken) !== null && _a !== void 0 ? _a : uuid_1.v4() }, (input.DataAccessRoleArn !== undefined && {
...
const serializeAws_json1_1TerminologyData = (input, context) => {
    return Object.assign(Object.assign({}, (input.File !== undefined && {
...
const serializeAws_json1_1TranslateTextRequest = (input, context) => {
    return Object.assign(Object.assign(Object.assign(Object.assign({}, (input.SourceLanguageCode !== undefined && {
        SourceLanguageCode: input.SourceLanguageCode
...
const deserializeAws_json1_1DescribeTextTranslationJobResponse = (output, context) => {
    return {
        ...
        TextTranslationJobProperties: output.TextTranslationJobProperties !== undefined &&
...
const deserializeAws_json1_1DetectedLanguageLowConfidenceException = (output, context) => {
    return {
        ...
        DetectedLanguageCode: output.DetectedLanguageCode !== undefined &&
...
const deserializeAws_json1_1GetTerminologyResponse = (output, context) => {
    return {
        ...
        TerminologyDataLocation: output.TerminologyDataLocation !== undefined &&
            output.TerminologyDataLocation !== null
            ? deserializeAws_json1_1TerminologyDataLocation(output.TerminologyDataLocation, context)
            : undefined,
        TerminologyProperties: output.TerminologyProperties !== undefined &&
...
const deserializeAws_json1_1JobDetails = (output, context) => {
    return {
        __type: "JobDetails",
        DocumentsWithErrorsCount: output.DocumentsWithErrorsCount !== undefined &&
            output.DocumentsWithErrorsCount !== null
            ? output.DocumentsWithErrorsCount
            : undefined,
        InputDocumentsCount: output.InputDocumentsCount !== undefined &&
            output.InputDocumentsCount !== null
            ? output.InputDocumentsCount
            : undefined,
        TranslatedDocumentsCount: output.TranslatedDocumentsCount !== undefined &&
...
const deserializeAws_json1_1ListTerminologiesResponse = (output, context) => {
    return {
        ...
        NextToken: output.NextToken !== undefined && output.NextToken !== null
            ? output.NextToken
            : undefined,
        TerminologyPropertiesList: output.TerminologyPropertiesList !== undefined &&
...
const deserializeAws_json1_1ListTextTranslationJobsResponse = (output, context) => {
    return {
        ...
        NextToken: output.NextToken !== undefined && output.NextToken !== null
            ? output.NextToken
            : undefined,
        TextTranslationJobPropertiesList: output.TextTranslationJobPropertiesList !== undefined &&
...
const deserializeAws_json1_1Term = (output, context) => {
    return {
        __type: "Term",
        SourceText: output.SourceText !== undefined && output.SourceText !== null
            ? output.SourceText
            : undefined,
        TargetText: output.TargetText !== undefined && output.TargetText !== null
            ? output.TargetText
            : undefined
    };
};
...
const deserializeAws_json1_1TerminologyDataLocation = (output, context) => {
    return {
        ...
        Location: output.Location !== undefined && output.Location !== null
            ? output.Location
            : undefined,
        RepositoryType: output.RepositoryType !== undefined && output.RepositoryType !== null
...
const deserializeAws_json1_1TerminologyProperties = (output, context) => {
    return {
        ...
        Name: output.Name !== undefined && output.Name !== null
            ? output.Name
            : undefined,
        SizeBytes: output.SizeBytes !== undefined && output.SizeBytes !== null
            ? output.SizeBytes
            : undefined,
        SourceLanguageCode: output.SourceLanguageCode !== undefined &&
            output.SourceLanguageCode !== null
            ? output.SourceLanguageCode
            : undefined,
        TargetLanguageCodes: output.TargetLanguageCodes !== undefined &&
            output.TargetLanguageCodes !== null
            ? deserializeAws_json1_1LanguageCodeStringList(output.TargetLanguageCodes, context)
            : undefined,
        TermCount: output.TermCount !== undefined && output.TermCount !== null
            ? output.TermCount
            : undefined
    };
};
...
const deserializeAws_json1_1TranslateTextResponse = (output, context) => {
    return {
        ...
        AppliedTerminologies: output.AppliedTerminologies !== undefined &&
        ...
        SourceLanguageCode: output.SourceLanguageCode !== undefined &&
            ...
            ? output.SourceLanguageCode
            : undefined,
        TargetLanguageCode: output.TargetLanguageCode !== undefined &&
            output.TargetLanguageCode !== null
            ? output.TargetLanguageCode
            : undefined,
        TranslatedText: output.TranslatedText !== undefined && output.TranslatedText !== null
